<x-card-basic class="md:col-span-4">
    ...
    <div class="px-2.5 py-3">
        <form action="">
            <x-form.input-float label="Permission" id="permission" name="form.name"
            ...
            <div class="flex justify-end mt-3">
                ...
                <x-button class="btnPrimary" wire:click.prevent="createPermission">
                    <x-slot:loading wire:target="createPermission">
                        Menyimpan
                    </x-slot:loading>
                    <x-slot:default wire:target="createPermission">
                        Simpan
