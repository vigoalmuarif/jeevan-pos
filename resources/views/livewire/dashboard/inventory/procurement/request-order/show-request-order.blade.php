            ...
            <form action="" wire:submit="save()">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-5 mb-6">
                    <x-card-basic class="py-5 w-full dark:border-transparent border-transparent px-4 md:col-span-6">
                        <div class="grid grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-10">
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-slate-500">No Transaksi</p>
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-slate-500">Tanggal Permintaan</p>
                                    <p class="text-base font-medium text-slate-700 dark:text-slate-300">
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-slate-500">Pembuat</p>
                                    <p class="text-base font-medium text-slate-700 dark:text-slate-300">
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-slate-500">Permintaan</p>
                                    <p class="text-base font-medium text-slate-700 dark:text-slate-300">
                                ...
                                <div>
                                    ...
                                    <p class="text-base font-medium text-slate-700 dark:text-slate-300">
                                        @if ($requestOrder->status == 'draft')
                                            <span
                                                class="rounded-full text-base font-medium  text-gray-500  dark:text-white">Draft</span>
                                        @elseif ($requestOrder->status == 'requested')
                                            <span
                                                class="rounded-full text-base font-medium bg-gray-100 text-gray-800  dark:text-white">Requested</span>
                                        @elseif ($requestOrder->status == 'reviewed')
                                            <span
                                                class="rounded-full text-base font-medium text-sky-800 dark:text-sky-500">Reviewed</span>
                                        @elseif ($requestOrder->status == 'approved')
                                            <span
                                                class="rounded-full text-base font-medium text-teal-800 dark:text-teal-500">Approved</span>
                                        @elseif ($requestOrder->status == 'partial_approved')
                                            <span
                                                class="rounded-full text-base font-medium text-amber-800 dark:text-amber-500">Partial
                                                Approved</span>
                                        @elseif ($requestOrder->status == 'ready_to_send')
                                            <span
                                                class="rounded-full text-base font-medium text-indigo-800 dark:text-indigo-500">Ready
                                                to Send</span>
                                        @elseif ($requestOrder->status == 'shipped')
                                            <span
                                                class="rounded-full text-base font-medium text-purple-800 dark:text-purple-500">Shipped</span>
                                        @elseif ($requestOrder->status == 'received')
                                            <span
                                                class="rounded-full text-base font-medium text-lime-800 dark:text-lime-500">Recevied</span>
                                        @elseif ($requestOrder->status == 'completed')
                                            <span
                                                class="rounded-full text-base font-medium text-green-800  dark:text-green-500">Completed</span>
                                        @elseif ($requestOrder->status == 'rejected')
                                            <span
                                                class="rounded-full text-base font-medium text-rose-800 dark:text-rose-500">Rejected</span>
                                        @elseif ($requestOrder->status == 'cancelled')
                                            <span
                                                class="rounded-full text-base font-medium text-red-800 dark:text-red-500">Cancelled</span>
                                        @endif
                                    </p>
                                </div>
                            </div>
                    ...
                    <x-card-basic class="py-5 w-full dark:border-transparent border-transparent px-4 md:col-span-6">
                        <div class="grid grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-10">
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-slate-500">Belum Diproses</p>
                                    <p class="text-base font-medium text-slate-700 dark:text-slate-300">
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-slate-500">Partial</p>
                                    <p class="text-base font-medium text-slate-700 dark:text-slate-300">
                                        {{ $totalPartial }} Item</p>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-slate-500">FulFilled</p>
                                    <p class="text-base font-medium text-slate-700 dark:text-slate-300">
                                    ...
                                    <tr class="@if ($item['status'] == 'rejected') bg-rose-600/10 hover:bg-rose-600/20 dark:hover:bg-rose-600/20 @elseif($item['status'] == 'approved') bg-green-600/10 hover:bg-green-600/20 dark:hover:bg-green-600/20 @elseif($item['status'] == 'partial_approved') bg-amber-600/10 hover:bg-amber-600/20 dark:hover:bg-amber-600/20  @elseif($item['status'] == 'over_qty') bg-violet-600/10 hover:bg-violet-600/20 dark:hover:bg-violet-600/20  @else {{ '' }} @endif group"
                                        ...
                                        <td
                                            ...
                                            <x-form.input
                                                ...
                                                wire:model.debounce.500ms="requestOrderItems.{{ $index }}.qtyApproved"
                                                wire:keyup.debounce.500ms="validasiQtyApproved({{ $index }})"
