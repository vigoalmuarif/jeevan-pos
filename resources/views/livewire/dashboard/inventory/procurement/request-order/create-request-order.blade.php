<div>
    ...
    <form action="" wire:submit="save()">
        <x-card-basic class="py-5 w-full dark:border-transparent border-transparent px-4 mb-3">
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <div>
                        ...
                        <x-form.input type="text" name="date" id="date" wire:model.live="date"
                            value="{{ auth()->user()->name }}" placeholder="User Pembuat" readonly autocomplete="off"
                            wire:model="user" />
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
            <x-card-basic class="py-5 w-full dark:border-transparent border-transparent px-4 md:col-span-3">
                <div class="flex flex-col flex-wrap w-full">
                    ...
                    <div class="grid grid-cols-1 w-full gap-2.5">
            ...
            <div class=" md:col-span-9">
                <x-card-basic class="overflow-x-auto w-full scrollbar-thin">
                    <div class="overflow-auto max-h-[40vh] scrollbar-thin" id="wrapperTable">
