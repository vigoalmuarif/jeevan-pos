...
$.extend( true, DataTable.defaults, {
    ...
    language: {
        processing: '<div class="flex items-center  justify-center">' +
                    '<div class="py-2 inline-flex items-center justify-center px-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl ">' +
...
$.extend( true, DataTable.ext.classes, {
	container: "dt-container dt-tailwindcss relative pt-1",
	search: {
		input: "border placeholder-gray-500 ml-2 px-3 py-2 rounded-lg border-gray-200 focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-primary-500 dark:placeholder-gray-400"
	},
	length: {
		select: "border py-2 pr-7 rounded-lg border-gray-200 focus:border-primary-500  focus:ring-primary-500  dark:bg-gray-800 dark:border-gray-600 dark:focus:border-primary-500"
	},
	processing: {
		container: "dt-processing z-[9999] w-full absolute top-1/2 left-1/2 translate-x-1/2 -translate-y-1/2"
	},
	paging: {
