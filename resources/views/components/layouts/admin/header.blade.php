    ...
    <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
      ...
      <div class="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
        ...
        <div class="flex flex-row items-center justify-end gap-1">
          ...
          <a href="{{ route('dashboards.cashier.index') }}" target="_blank" class="btnPrimary rounded-full mx-5">
            Sales
            ...
            <div
              ...
              <div class="p-1.5 space-y-0.5">
                ...
                <form action="{{ route('logout') }}" method="post">
                  @csrf
                  <button type="submit" class="logout inline-flex w-full items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300">
                    <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round">
