...
<body class="bg-gray-50 dark:bg-neutral-900 h-screen">
        ...
        <header class="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
            <nav
                class="mt-4 relative max-w-2xl w-full bg-white border border-gray-200 rounded-full mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:px-4 md:mx-auto dark:bg-neutral-800 dark:border-neutral-700">
                        ...
                        <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80"
                            ...
                            <svg class="w-24 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none"
                                ...
                                <path
                                    ...
                                    class="stroke-gray-800 dark:stroke-white" stroke="currentColor" stroke-width="2" />
                                <circle cx="13" cy="16.5214" r="5" class="fill-gray-800 dark:fill-white"
                                    fill="currentColor" />
                            </svg>
                        </a>
                        <!-- End Logo -->
                ...
                <div id="hs-navbar-header-floating"
                    ...
                    <div
                        ...
                        <a class="py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 border-gray-800 font-medium text-gray-800 focus:outline-hidden dark:border-neutral-200 dark:text-neutral-200"
